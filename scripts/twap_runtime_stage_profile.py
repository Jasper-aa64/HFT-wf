...
def main() -> int:
    ...
    parser.add_argument("--remote-run-root", default="/root/work/optimization_experiments/runs")
    parser.add_argument("--remote-workspace-root", default="/root/work/optimization_experiments/local_agent_candidates")

...
# GateKeeper Mode Execution Outline

GateKeeper Mode is a software-quality workflow, not ordinary AI chat.
...
Once `scripts/evaluate.sh` exists, prefer calling it from GateKeeper Mode as well, so command lists are maintained in one place.

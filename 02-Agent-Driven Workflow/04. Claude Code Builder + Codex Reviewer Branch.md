...
This branch implements Full GateKeeper Mode with local CLIs.
...
## 3. Implemented Workflow: Full GateKeeper Mode v1.1
...
```bash
git apply gatekeeper_runs/<timestamp>/attempt-N/patch.diff
```
...
```text
1. GateKeeper Lite+                    DONE
   Builder -> Executor -> Critic -> Retry -> Decision

2. Full GateKeeper Mode v1.1            DONE (2026-05-03)
